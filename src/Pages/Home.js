      ...
      <InnerOuterBox>
        <div className="home text-center">
          ...
          <div className="d-flex gap-5 mt-3 mb-4 justify-content-center">
            ...
            <a
              href="https://github.com/daffakurnia11"
              target="_blank"
              rel="noopener noreferrer"
            >
              <OuterIcon>
          ...
          <p className="home-desc mb-1">
            Hi! I am <span className="desc-highlight">Daffa Kurnia Fatah</span>{" "}
            you can call me <span className="desc-highlight">Daffa</span>
          </p>
          <p className="home-desc mb-1">
            As a <span className="desc-highlight">software developer</span>{" "}
            experienced with <span className="desc-highlight">Laravel</span>,{" "}
            <span className="desc-highlight">React</span>, and{" "}
            <span className="desc-highlight">Kotlin</span>
          </p>
          <LongDivider />
